          ...
          <div className='topCreationDetailsHub baseline'>
            <div className='topCreationLeft'>
              <div className='topCreationLeftNames'>
                <h6>The Almond Breads</h6>
              </div>
              <div className='topCreationLeftFollowers'>
                <ul>
                  <li>
                    <span className='artImage'><img src='/lunartImages/collections/Collection - Preview of the Julia Collection/Aszoo/profile.png' alt="images"/></span>
                    <h6>Coming Soon<p>Aszoo</p></h6>
                  </li>
                  <li>
                    <span className='artImage'><img src='/lunartImages/collections/Collection - Preview of the Julia Collection/J.C/profile.jpg' alt="images"/></span>
            ...
            <div className='topCreationRight'>
              <span className="topCreationRightSpan"><img src="/lunartImages/collections/Collection - Preview of the Julia Collection/inner/p1.png" alt=""/></span>
              <ul><li><img src="/lunartImages/collections/Collection - Preview of the Julia Collection/inner/p2.png" alt=""/></li><li><img src="/lunartImages/collections/Collection - Preview of the Julia Collection/inner/p3.png" alt=""/></li><li><img src="/lunartImages/collections/Collection - Preview of the Julia Collection/inner/p4.png" alt=""/></li></ul>
            </div>
          </div>
        </div>
      </div>

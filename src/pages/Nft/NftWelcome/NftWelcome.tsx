...
<a href="/artist">Discover Artists <img src='/lunartImages/rightArrow.svg' alt="images"/></a>
                ...
                <div className='lunaBannerRight'>
                  <ul>
                    <li>Artists<b>11</b></li>
                    <li>Arts<b>400</b></li>
                    <li>Total Value<b>Coming Soon</b></li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        {/* Categories Section */}
          <div className='specialBurn'>
            ...
            <section>
            <h6>Special Burn!</h6>
            <p>In order to celebrate our launch, we are releasing a special edition LunArt ARTS burn NFT! Secure your Below:</p>
            {/* <a href="/burn">Learn more <img src='/lunartImages/arrowRightBlack.svg'/></a> */}
            <ReactTooltip effect='solid' place='bottom' type='light' multiline textColor="white" backgroundColor="rgba(2, 2, 16)" className="tooltip" />
            <span data-tip="Coming Soon"><a>Learn more <img src='/lunartImages/arrowRightBlack.svg'/></a></span>
            </section>
          ...
          <div className='leaderBoard dnone'>
            <div className='wrapper'>
